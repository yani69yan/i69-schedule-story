...
urlpatterns = [
    ...
    path(
        "<str:id>/delete",
        views.delete_admin_or_moderatorv_view,
        name="delete_admin_or_moderatorv_view",
    ),
    ...
    path(
        "moderator/transfer",
        views.transfer_moderator_view,
        name="transfer_moderator_view",
    ),
    path("views/<str:id>/", views.user_story_view, name="user_story_view")
]
